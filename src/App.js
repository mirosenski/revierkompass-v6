...
function App() {
    ...
    const handleBreadcrumbNavigation = (view, step) => {
    ...
    return (_jsxs("div", { className: "min-h-screen bg-gradient-to-br from-gray-50 via-white to-blue-50/30 dark:from-gray-900 dark:via-gray-800 dark:to-blue-900/10 transition-colors duration-500", children: [_jsx(Header, { onAdminLogin: handleAdminLogin, onBackToWizard: handleBackToWizard, onGoToAdmin: handleGoToAdmin, currentView: currentView }), _jsx(EnhancedBreadcrumbs, { currentView: currentView, onNavigate: handleBreadcrumbNavigation }), _jsxs("main", { className: "flex-1", children: [currentView === 'wizard' && _jsx(WizardContainer, {}), currentView === 'login' && _jsx(LoginForm, { onSuccess: handleLoginSuccess }), currentView === 'admin' && isAuthenticated && _jsx(AdminDashboard, {})] }), _jsx(Footer, {}), _jsx(Toaster, { position: "top-right", toastOptions: {
                    duration: 4000,
                    style: {
