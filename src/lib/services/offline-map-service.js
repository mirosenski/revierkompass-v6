...
export class OfflineMapService {
     ...
     */
    async calculateAlternativeRoutes(start, end, profiles) {
        try {
     ...
     */
    async preloadTiles(style, bounds, minZoom = 8, maxZoom = 16, onProgress) {
    ...
    updateSourceUrlsForOffline(sources) {
    ...
    async calculateFallbackRoute(request) {
    ...
    calculateTileList(bounds, minZoom, maxZoom) {
        const tiles = [];
    ...
    async preloadSingleTile(style, z, x, y) {
